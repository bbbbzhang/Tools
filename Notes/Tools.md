...
深世海 女神异闻录3P 4G 4-U2 5R 5T 5S 合金装备大师合集Vol.1 传说之下 巡警
...
我的物品
产量大，用户基数大的东西，丢了或者坏了再去网上买，晚买享折扣，晚买的东西更先进
...
WIN电脑到手设置
更新系统、更新驱动、关通知、关广告、关自启动、显示隐藏文件、改硬盘名称、任务栏、开始菜单、右下角弹窗、桌面、壁纸、锁屏壁纸、锁屏显示、登录账号、下载常用应用程序、应用程序安装至C盘默认位置、合盖不影响操作(笔记本)、不休眠、所有文件都下载至Downloads、护眼、高刷、英文键盘、不要嫌弃打开GameBar、关闭拖动窗口布局、删除不常用的系统软件、触摸板设置
...
很多游戏内部的垂直同步实现有问题，开启垂直同步可能造成原因不明的性能下降和卡顿。
优点：
防止画面撕裂
问题：
会锁帧，并且造成输入延迟
...
我的WIN游戏库
52款NS玩不到的游戏，只能运行PC版/PC破解版
黑暗之魂3 艾尔登法环 只狼 黑神话-悟空 侠盗猎车手5 荒野大镖客-救赎2
生化危机2、3、4 重制版 生化危机7、8 鬼泣4、5 怪物猎人-世界
德军总部-新秩序 德军总部-旧血脉 街头霸王5
山 见证者 植物精灵 毛线先生 还愿 崩溃大陆2
爷爷的城市 银河历险记1、2、3 纸境 不要喂食猴子2099 去月球-海滩 双影奇境
死亡循环 死亡回归 寂静岭2 重制版 瑞奇与叮当-时空跳转 暗喻幻想 心灵杀手2
往日不再 死亡搁浅-导演剪辑版 对马岛之魂-导演剪辑版 底特律-化身为人
地平线-西之绝境 地平线-零之曙光 重制版 神秘海域-盗贼遗产合集
最后生还者1、2 重制版 战神4、5 最终幻想7-重制版、7-重生、15、16
合计约3.5T

18款NS玩不到的游戏，但是可以运行模拟器版
出击飞龙 植物大战僵尸 马克思佩恩1、2、3 恶霸鲁尼 侠盗猎车手4 黑暗之魂2
合金装备-崛起 尼尔-人工生命 最终幻想13-1、13-2、13-3 花 风之旅人 
街头霸王4 终极版 超时空之轮 鬼泣DMC
