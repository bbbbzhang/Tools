...
1、清洁不干净会导致耳朵发炎
2、堵着耳朵耳道空气不流通会闷热发痒
3、耳朵形成封闭空间，声音是震动传播的，会导致耳朵内压力反复变化
不在乎的就买吧，一买一个不吱

头戴耳机:
脏成什么样了还往耳朵上放，夏天出门库库冒汗，油脂汗水灰层聚合物都包浆了（我没买过但是我知道，参考网吧和网友发图）

耳挂耳机:
勒，每个人耳朵都不一样，公模的形状不是每一个人都戴着舒适的，除非花钱定制，但是花钱定制也会遇到技术不好的（花很多钱的那没的说）

半入耳:
容易掉，外部杂音多（干扰耳机音质，声音会相互碰撞失真），没啥其他缺点了，但如果在有鸟叫声水声风声的环境里半入耳一戴，如听仙乐耳暂明
```
...
IOS端RA
用户数据位置
根目录/RetroArch/RetroArch
ROMs位置
根目录/RetroArch/RetroArch/ROMs
PS1核心PCSX ReARMed
缺少记忆列表位置的设置
...
mGBA画面错误
VBA-NEXT，只能运行GBA游戏
VBA-M即时存档和读档都会闪退，原因是某些VBA-M的即时存档文件出错导致的
...
运行流畅：Arcade GBA GBC GB SNES NES FDS MD
PS1 NGP
可运行轻量游戏：PSP、N64
运行不流畅：NDS、SS、DC核心反应慢
运行不了：PS2、NGC、WII、3DS
(NDS端的MelonDS独立模拟器，无法保存配置，运行流畅)

安卓和WIN的核心版本区别不是很大的话
states和saves都互通

经测试
Snes9x 2005、Flycast的state不互通
